...
submit_test_image_dir='/home/nemo/kaggle/data/test/'
train_csv_path='/home/nemo/kaggle/data/train.csv'
image_dir='/home/nemo/kaggle/data/train/'
embedding_size=512
...
def create_input_pipeline(input_queue, image_size, nrof_preprocess_threads, batch_size_placeholder):
    ...
    for _ in range(nrof_preprocess_threads):
        ...
        for filename in tf.unstack(filenames):
            ...
            image = tf.py_func(util.read_cropped_image,[image,filename,False],tf.float32)

...
def main(args):
    ...
    train_set = util.get_data_set_train(args.data_dir,iggore_single_image=True,useAll=False)
...
#                 image = tf.image.resize_image_with_crop_or_pad(image, args.image_size, args.image_size)
                ...
                image = tf.py_func(rotate_shear_zoom,[image],tf.float32)
...
def parse_arguments(argv):
    ...
    parser.add_argument('--data_dir', type=str,
        ...
        default='/home/nemo/kaggle/data/clean_train_422/')
    ...
    parser.add_argument('--image_size', type=int,
        help='Image size (height, width) in pixels.', default=384)
    ...
    parser.add_argument('--learning_rate_schedule_file', type=str,
        help='File containing the learning rate schedule that is used when learning_rate is set to to -1.', default='data/learning_rate_schedule_classifier_vggface2.txt')
